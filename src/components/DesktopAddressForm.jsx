...
export default function DesktopAddressForm({ onSave }) {
  ...
  return (
    <div className="desktopAddress-baseAddressForm">
      <div>
        <div className="addressForm-container">
          <div className="addressForm-container-scrollable addressForm-containerMT addressForm-container-scrollableDesktop">
            <div className="addressForm-containerDesktop noMargin">
              <div className="addressForm-baseFormHeader">Contact Details</div>
            ...
            <div className="addressForm-containerDesktop noMargin">
              <div className="addressForm-baseFormHeader">Address</div>
              <div className="floatingInputRow">
                <div className="floatingInput-container">
                  <input
                    type="text"
            ...
            <div className="addressForm-containerDesktop noMargin">
              <div className="addressForm-baseFormHeader">Address TYPE</div>
              <div>
